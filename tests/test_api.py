"""Tests for Dragino api."""
import asyncio

import aiohttp
from homeassistant.helpers.aiohttp_client import async_get_clientsession

from custom_components.dragino.api import IntegrationDraginoApiClient
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = IntegrationDraginoApiClient("test", "test", async_get_clientsession(hass))
