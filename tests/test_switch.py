...
from custom_components.dragino import async_setup_entry
from custom_components.dragino.const import DEFAULT_NAME, DOMAIN, SWITCH
...
async def test_switch_services(hass):
    ...
    with patch(
        "custom_components.dragino.IntegrationDraginoApiClient.async_set_title"
    ) as title_func:
